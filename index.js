...
app.get("/", (_, res) => res.send("maie modmail running"));
...
// ================= CONFIG =================
const GUILD_ID = "1297061235178737745";
const FORUM_CHANNEL_ID = "1506787982194118867";
const STAFF_ROLE_ID = "1467914227581980783";
  ...
  try {
      ...
      if (!thread) {
        ...
        try {
          await message.author.send({
            embeds: [
              new EmbedBuilder()
                .setTitle("<a:0shoes:1468025051315044483> ⋯ new thread opened")
                .setDescription(
    ...
    if (message.content === "!close") {
      ...
      await message.channel.send({
        embeds: [
          new EmbedBuilder()
            .setTitle("<a:003_black_key:1468007376543285531> ⋯ thread closed")
